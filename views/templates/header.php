		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						<li> <a href="app-emailbox.html"><i class="bx bx-right-arrow-alt"></i>medida</a>
						</li>
						<li> <a href="app-chat-box.html"><i class="bx bx-right-arrow-alt"></i>Categoria</a>
						</li>
						<li> <a href="app-chat-box.html"><i class="bx bx-right-arrow-alt"></i>ji</a>
						</li>
					</ul>
				</li>
                <li>
					...
					<ul>
						...
						<li> <a href="app-chat-box.html"><i class="bx bx-right-arrow-alt"></i>Configuracion</a>
						</li>
						<li> <a href="app-chat-box.html"><i class="bx bx-right-arrow-alt"></i>ji</a>
						</li>
					</ul>
				...
				<li>
					<a href="widgets.html">
						<div class="parent-icon"><i class="fa-brands fa-shopify"></i>
						</div>
				...
				<li>
					<a href="widgets.html">
						...
						<div class="menu-title">Cotizacioness</div>
					</a>
				</li>
				<li>
					<a href="widgets.html">
				...
				<li>
					<a href="widgets.html">
						...
						<div class="menu-title">provedores</div>
					</a>
				</li>
			</ul>
			<!--end navigation-->
