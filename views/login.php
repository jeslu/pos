										...
										<form class="row g-3" id="formulario" method="POST" autocomplete="off">
											...
											<div class="col-12">
												...
												<div class="input-group" id="show_hide_password">
													<input type="password" class="form-control border-end-0" id="clave" name="clave" value="admin" placeholder="Clave">
											...
											<div class="col-md-6 text-end">	<a href="authentication-forgot-password.html">olvidates la clave?</a>
											</div>
											<div class="col-12">
												<div class="d-grid">
